...
export class AdminController {
  ...
  @Post("/verify-signup")
  async verifySignup(
    @Body() data: VerifyAdminSignupDto
  ...
  async logAdminRequest(
    @Body() data: LoginAdminRequestDto
  ...
  @Post("/login")
  @Throttle({ default: { limit: 5, ttl: 60000 } })
  async login(@Body() data: LoginAdminDto): Promise<{ token: string }> {
